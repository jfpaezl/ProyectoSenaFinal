function eventListeners(){document.querySelector(".mobile-menu").addEventListener("click",navegacionResponsive)}function navegacionResponsive(){const e=document.querySelector(".navegacion"),n=document.querySelector(".login");e.classList.toggle("mostrar"),n.classList.toggle("mostrar")}
